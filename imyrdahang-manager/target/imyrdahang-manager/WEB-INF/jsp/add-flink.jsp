...
<title>增加友情链接 - imyrdahang博客管理系统</title>
        ...
        <form id="friendship" method="post" class="add-flink-form" autocomplete="off" draggable="false">
          <div class="col-md-9">
            ...
            <div class="add-article-box">
              ...
              <div class="add-article-box-content">
                <input type="text" id="eName" name="eName" class="form-control" placeholder="在此处输入名称" required autofocus autocomplete="off">
                <span class="prompt-text">例如：某某某的关于什么什么的文章，论文</span> </div>
            </div>
            <div class="add-article-box">
              <h2 class="add-article-box-title"><span>WEB地址--必填</span></h2>
              <div class="add-article-box-content">
                <input type="text" id="eUrl" name="eUrl" class="form-control" placeholder="在此处输入URL地址" required autocomplete="off">
            ...
            <div class="add-article-box">
              ...
              <div class="add-article-box-content">
                <textarea id="eDepict" class="form-control" name="eDepict" autocomplete="off"></textarea>
          ...
          <div class="col-md-3">
            ...
            <div class="add-article-box">
              ...
              <div class="add-article-box-content">
                <p><label>标记：</label><input type="radio" name="eState" value="1" checked />使用&nbsp;&nbsp;<input type="radio" name="eState" value="2" />放弃&nbsp;&nbsp;
              </div>
...
<script type="text/javascript" charset="utf-8" src="/js/pageOFjs/add-flink.js"></script>
</body>
</html>