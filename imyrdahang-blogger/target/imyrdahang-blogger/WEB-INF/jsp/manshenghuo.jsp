...
<article>
  <div class="container">
    <h2 class="ctitle"><b>慢生活</b> <span>${manshenghuoCtitle.cData1 } </span></h2>
      ...
      <li>
		...
		<div class="cbp_tmlabel" data-scroll-reveal="enter right over 1s" >
			<h2>${article.aTitle}</h2>
			 <p><span class="blogpic"><a href="/content/${article.aId }.html" target="_blank" title="${article.aTitle}"><img src="${article.aChart}"></a></span>${article.aAbstract}</p>
...
<script>
	...
	var url="/manshenghuo.html?pages=";
</script>
</body>
</html>
